...
shakey_help :-
    ...
    write('- connected(corridor, room1)'), nl,
    write('- connected(corridor, room2)'), nl,
    write('- connected(corridor, room3)'), nl,
    write('- connected(room1, door1)'), nl,
    write('- connected(room2, door2)'), nl,
    write('- connected(room3, door3)'), nl,
    write('- connected(door1, room1)'), nl,
    write('- connected(door2, room2)'), nl,
    write('- connected(door3, room3)'), nl,
    write('- connected(corridor, door1)'), nl,
    write('- connected(corridor, door2)'), nl,
    write('- connected(corridor, door3)'), nl,
    write('- connected(door1, corridor)'), nl,
    write('- connected(door2, corridor)'), nl,
    write('- connected(door3, corridor)'), nl,
